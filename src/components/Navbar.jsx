    ...
    <header className="fixed top-0 w-full bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 backdrop-blur-md shadow-lg z-50 border-b border-blue-800/30">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="text-lg sm:text-xl font-bold bg-gradient-to-r from-yellow-300 via-yellow-200 to-yellow-600 bg-clip-text text-transparent leading-tight">
            Assessoria<br className="hidden sm:block" /> Acadêmica
          </div>
        </div>
        ...
        <ul className="hidden lg:flex gap-6 xl:gap-8 items-center">
          ...
          <li>
            <a
              href="#contact"
              className="bg-gradient-to-r from-blue-500 to-cyan-400 text-white px-5 py-2.5 rounded-full font-medium hover:from-blue-600 hover:to-cyan-500 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 transform"
            >
              Fale Conosco
            </a>
          </li>
